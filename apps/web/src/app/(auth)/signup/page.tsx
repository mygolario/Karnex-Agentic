...
export default function SignupPage({
  ...
  const handleSocialLogin = async (provider: 'github' | 'google') => {
    ...
    try {
      ...
      setStatus('error')
      setErrorMessage(`Failed to initialize ${provider} signup.`)
    }
  }
        ...
        <div className="w-full max-w-sm mx-auto my-auto py-12">
          {status === 'sent' ? (
            <div className="text-center">
              ...
              <p className="mt-1.5 text-[12px] text-[#525252]">Click the link to complete your signup.</p>
              <button
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="name-input" className="block text-[13px] font-medium text-[#a1a1a1] mb-2">
                    Full name
                  </label>
              ...
              <p className="mt-8 text-center text-[13px] text-[#737373]">
                ...
                <Link href="/login" className="font-medium text-[#6366f1] hover:text-[#5558e6] transition-colors ml-1">
                  Sign in
                </Link>
              </p>
            </>
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end p-16 bg-gradient-to-t from-[#050505]/80 via-transparent to-transparent">
          <div className="max-w-md">
            ...
            <blockquote className="font-display font-medium text-[28px] leading-[1.3] text-white tracking-[-0.02em] mb-6">
              &ldquo;From raw idea to first revenue in 90 days. Deployed in parallel by 27 specialized AI agents.&rdquo;
            </blockquote>
            <div className="flex items-center gap-3">
              <div className="h-px w-8 bg-[#1a1a1a]" />
              <span className="text-[13px] text-[#737373]">Karnex Pipeline</span>
            </div>
          </div>
        </div>
      </div>
